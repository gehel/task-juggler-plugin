...
public class TJDurationImpl extends ASTWrapperPsiElement implements TJDuration {

  public TJDurationImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public PsiElement getDuration_() {
    return findNotNullChildByType(DURATION_);
  }
