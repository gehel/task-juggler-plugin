...
public class TJProjectImpl extends ASTWrapperPsiElement implements TJProject {

  public TJProjectImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public TJInterval2 getInterval2() {
    return findNotNullChildByClass(TJInterval2.class);
  }
