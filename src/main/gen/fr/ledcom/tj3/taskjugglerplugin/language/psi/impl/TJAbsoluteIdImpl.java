...
public class TJAbsoluteIdImpl extends ASTWrapperPsiElement implements TJAbsoluteId {

  public TJAbsoluteIdImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TJVisitor visitor) {
    visitor.visitAbsoluteId(this);
  }
