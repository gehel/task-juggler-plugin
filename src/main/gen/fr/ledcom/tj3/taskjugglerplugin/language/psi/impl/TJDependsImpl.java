...
public class TJDependsImpl extends ASTWrapperPsiElement implements TJDepends {

  public TJDependsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TJVisitor visitor) {
    visitor.visitDepends(this);
  }
  ...
  @Override
  @Nullable
  public TJAbsoluteId getAbsoluteId() {
    return findChildByClass(TJAbsoluteId.class);
  }
